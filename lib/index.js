...
function scoreDealerHand () {
  ...
  if (dealerHand.score() > 21) {
    playerHand.renderMessage($("#dealer-message"), "<h2>BUSTED! <br> Player Wins!</h2>");
    game.initialize();
  } else if (dealerHand.score() === 21) {
    playerHand.renderMessage($("#dealer-message"), "<h2>Oh well – the dealer won!</h2>");
    game.initialize();
  }
}
